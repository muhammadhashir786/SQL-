-- Create database and table "startersql_6 & users_6"
-- update data into table 

CREATE DATABASE IF NOT EXISTS startersql_6;
USE startersql_6;
...
-- INSERT INTO users_6 (name, email, gender, date_of_birth, salary) VALUES
...
-- UPDATE users_6 SET salary = 45000 WHERE id = 3;
-- SELECT * FROM users_6;

-- UPDATE users_6 SET salary = 45000, email='aarav@aarav.com' WHERE id = 1;
-- SELECT * FROM users_6;

-- UPDATE users_6 SET salary=70000 WHERE id=5;
-- SELECT * FROM users_6;

-- UPDATE users_6 SET name='Aisha Khan' WHERE email='aisha@example.com';
-- SELECT * FROM users_6;

-- UPDATE users_6 SET salary=salary+10000 WHERE salary<60000;
-- SELECT * FROM users_6;

-- UPDATE users_6 SET gender = 'Other' WHERE name='Ishaan';
-- SELECT * FROM users_6;
