-- Create database and table "startersql_5 & users_5"
-- update data into table from CWH Script

CREATE DATABASE IF NOT EXISTS startersql_5;
USE startersql_5;
...
-- INSERT INTO users_5 (name, email, gender, date_of_birth, salary) VALUES
