-- Create database and table "startersql_7 & users_7"
-- update salary 50000 for all the users into table 

CREATE DATABASE IF NOT EXISTS startersql_7;
USE startersql_7;
...
-- INSERT INTO users_7 (name, email, gender, date_of_birth, salary) VALUES
...
-- UPDATE users_7 SET salary=100000;
SELECT * FROM users_7;
